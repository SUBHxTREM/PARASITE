...
NO_ADMIN = "`I am not an admin nub nigga!`"
NO_PERM = "`I don't have sufficient permissions! This is so sed. Alexa play Dil waale puch de ne chaa
Ooo...
Ohh..Ooooo
`"
...
async def promote(promt):
    ...
    try:
        ...
        await promt.edit("`Promoted Successfully! Now gib Parmty`")
